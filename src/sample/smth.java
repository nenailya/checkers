...
public static int[][] array;
    ...
    static void fooForEachCell(int x, int y) {
        ...
        if (colorOfChecker == 10) {
            ...
            if(checkForMinus2(x) && checkForMinus2(y) && array[x-2][y-2] == 811){ array[x-2][y-2] = 0; array[x-1][y-1] = 0; array[x][y] = 11; fooForYellowCellsDeleting();fooForWhiteYellowCellsDeleting(); player = 2;}////исправь////////
            if(checkForMinus2(x) && checkForPlus2(y)  && array[x-2][y+2] == 811){ array[x-2][y+2] = 0; array[x-1][y+1] = 0; array[x][y] = 11; fooForYellowCellsDeleting();fooForWhiteYellowCellsDeleting(); player = 2;}////исправь////////
            if(checkForPlus2(x) && checkForMinus2(y)  && array[x+2][y-2] == 811){ array[x+2][y-2] = 0; array[x+1][y-1] = 0; array[x][y] = 11; fooForYellowCellsDeleting();fooForWhiteYellowCellsDeleting(); player = 2;}////исправь////////
            if(checkForPlus2(x) && checkForPlus2(y)   && array[x+2][y+2] == 811){ array[x+2][y+2] = 0; array[x+1][y+1] = 0; array[x][y] = 11; fooForYellowCellsDeleting();fooForWhiteYellowCellsDeleting(); player = 2;}////исправь////////

            if(checkForMinus2(x) && checkForMinus2(y) && array[x-2][y-2] == 812){ array[x-2][y-2] = 0; array[x-1][y-1] = 0; array[x][y] = 12; fooForYellowCellsDeleting();fooForBlackYellowCellsDeleting(); player = 1;}////исправь////////
            if(checkForMinus2(x) && checkForPlus2(y)  && array[x-2][y+2] == 812){ array[x-2][y+2] = 0; array[x-1][y+1] = 0; array[x][y] = 12; fooForYellowCellsDeleting();fooForBlackYellowCellsDeleting(); player = 1;}////исправь////////
            if(checkForPlus2(x) && checkForMinus2(y)  && array[x+2][y-2] == 812){ array[x+2][y-2] = 0; array[x+1][y-1] = 0; array[x][y] = 12; fooForYellowCellsDeleting();fooForBlackYellowCellsDeleting(); player = 1;}////исправь////////
    ...
    static boolean whiteCanKillCheck(int i, int j) {
        int k = 0;
        int m = 0;
        if (player == 1)
            for (int x = 0; x < 8; x++) {
    ...
    static boolean blackCanKillCheck(int i, int j) {
        int k = 0;
        int m = 0;
        if (player == 2)
            for (int x = 0; x < 8; x++) {
