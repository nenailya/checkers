...
public static int[][] array;
    ...
    static void fooForEachCell(int x, int y) {
        ...
        if (colorOfChecker == 10) {
            ...
            if(checkForMinus2(x) && checkForMinus2(y) && array[x-2][y-2] == 81){ array[x-2][y-2] = 0; array[x-1][y-1] = 0; array[x][y] = 1; whiteKingCheck(x, y); fooForYellowCellsDeleting();fooForWhiteYellowCellsDeleting();  if(whiteCanKillCheck2(x, y) )  {player = 1;aa = x; bb = y; } else {player = 2;}}////исправь////////
            if(checkForMinus2(x) && checkForPlus2(y)  && array[x-2][y+2] == 81){ array[x-2][y+2] = 0; array[x-1][y+1] = 0; array[x][y] = 1; whiteKingCheck(x, y); fooForYellowCellsDeleting();fooForWhiteYellowCellsDeleting();  if(whiteCanKillCheck2(x, y) )  {player = 1;aa = x; bb = y; } else {player = 2;}}////исправь////////
            if(checkForPlus2(x) && checkForMinus2(y)  && array[x+2][y-2] == 82){ array[x+2][y-2] = 0; array[x+1][y-1] = 0; array[x][y] = 2; blackKingCheck(x, y); fooForYellowCellsDeleting();fooForBlackYellowCellsDeleting();  if(blackCanKillCheck2(x, y) )  {player = 2;aa = x; bb = y; } else {player = 1;}}////исправь////////
            if(checkForPlus2(x) && checkForPlus2(y)   && array[x+2][y+2] == 82){ array[x+2][y+2] = 0; array[x+1][y+1] = 0; array[x][y] = 2; blackKingCheck(x, y); fooForYellowCellsDeleting();fooForBlackYellowCellsDeleting();  if(blackCanKillCheck2(x, y) )  {player = 2;aa = x; bb = y; } else {player = 1;}}////исправь////////

            if(checkForMinus2(x) && checkForMinus2(y) && array[x-2][y-2] == 811){ array[x-2][y-2] = 0; array[x-1][y-1] = 0; array[x][y] = 11; fooForYellowCellsDeleting();fooForWhiteYellowCellsDeleting();  if(whiteCanKillCheck2(x, y))           {player = 1;aa = x; bb = y; } else {player = 2;}}////исправь////////
            if(checkForMinus2(x) && checkForPlus2(y)  && array[x-2][y+2] == 811){ array[x-2][y+2] = 0; array[x-1][y+1] = 0; array[x][y] = 11; fooForYellowCellsDeleting();fooForWhiteYellowCellsDeleting();  if(whiteCanKillCheck2(x, y))           {player = 1;aa = x; bb = y; } else {player = 2;}}////исправь////////
            if(checkForPlus2(x) && checkForMinus2(y)  && array[x+2][y-2] == 811){ array[x+2][y-2] = 0; array[x+1][y-1] = 0; array[x][y] = 11; fooForYellowCellsDeleting();fooForWhiteYellowCellsDeleting();  if(whiteCanKillCheck2(x, y))           {player = 1;aa = x; bb = y; } else {player = 2;}}////исправь////////
            if(checkForPlus2(x) && checkForPlus2(y)   && array[x+2][y+2] == 811){ array[x+2][y+2] = 0; array[x+1][y+1] = 0; array[x][y] = 11; fooForYellowCellsDeleting();fooForWhiteYellowCellsDeleting();  if(whiteCanKillCheck2(x, y))           {player = 1;aa = x; bb = y; } else {player = 2;}}////исправь////////

            if(checkForMinus2(x) && checkForMinus2(y) && array[x-2][y-2] == 812){ array[x-2][y-2] = 0; array[x-1][y-1] = 0; array[x][y] = 12; fooForYellowCellsDeleting();fooForBlackYellowCellsDeleting();  if(blackCanKillCheck2(x, y))           {player = 2;aa = x; bb = y; } else {player = 1;}}////исправь////////
            if(checkForMinus2(x) && checkForPlus2(y)  && array[x-2][y+2] == 812){ array[x-2][y+2] = 0; array[x-1][y+1] = 0; array[x][y] = 12; fooForYellowCellsDeleting();fooForBlackYellowCellsDeleting();  if(blackCanKillCheck2(x, y))           {player = 2;aa = x; bb = y; } else {player = 1;}}////исправь////////
            if(checkForPlus2(x) && checkForMinus2(y)  && array[x+2][y-2] == 812){ array[x+2][y-2] = 0; array[x+1][y-1] = 0; array[x][y] = 12; fooForYellowCellsDeleting();fooForBlackYellowCellsDeleting();  if(blackCanKillCheck2(x, y))           {player = 2;aa = x; bb = y; } else {player = 1;}}////исправь////////
            if(checkForPlus2(x) && checkForPlus2(y)   && array[x+2][y+2] == 812){ array[x+2][y+2] = 0; array[x+1][y+1] = 0; array[x][y] = 12; fooForYellowCellsDeleting();fooForBlackYellowCellsDeleting();  if(blackCanKillCheck2(x, y))           {player = 2;aa = x; bb = y; } else {player = 1;}}////исправь////////
        }
